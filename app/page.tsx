    ...
    <div className="min-h-screen bg-white text-black flex flex-col items-center justify-center px-4 py-12">
      <div className="max-w-4xl w-full text-center space-y-6">
        ...
        <img
          ...
          className="mx-auto mt-6 rounded-2xl shadow-md w-full max-w-2xl"
        />
        ...
        <div className="mt-16">
          ...
          <div className="mt-4 grid grid-cols-2 md:grid-cols-4 gap-4">
            <img src="/sample1.png" className="rounded-lg" alt="Example 1" />
            <img src="/sample2.png" className="rounded-lg" alt="Example 2" />
            <img src="/sample3.png" className="rounded-lg" alt="Example 3" />
            <img src="/sample4.png" className="rounded-lg" alt="Example 4" />
          </div>
        </div>
